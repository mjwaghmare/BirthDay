...
public class BuddyList extends AppCompatActivity {
    ...
    GridView gridView;
    ArrayList<Buddy> list;
    BuddyListAdapter adapter = null;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new BuddyListAdapter(this,R.layout.buddy_items,list);
        ...
        while (cursor.moveToNext()){
            ...
            list.add(new Buddy(id , name , dob , image)) ;
        }
        ...
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(BuddyList.this);
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0){
                            ...
                            showDialogUpdate(BuddyList.this , arrId.get(position));
                        }else {
                            //delete
    ...
    private void showDialogueDelete(final int idBuddy){
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(BuddyList.this);
        ...
        dialogDelete.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    ...
                    Toast.makeText(BuddyList.this, "Successfully deleted!!", Toast.LENGTH_SHORT).show();
